 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (((sagenes * 3 + arshins) * 16) + vershoks) * PI / (180 * 60 * 60)
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = (sec + min * 60 + grad * 3600) / 206265.0
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    var firstyear = initial + initial * percent / 100.0
    var secondyear = firstyear + firstyear * percent / 100.0
    var thirdyear = secondyear + secondyear * percent / 100.0
    return thirdyear
}
...
fun numberRevert(number: Int): Int {
    ...
    num /= 10
    var firstnum = num % 10
    var result = thirdnum * 100 + secondnum * 10 + firstnum
    return result
}